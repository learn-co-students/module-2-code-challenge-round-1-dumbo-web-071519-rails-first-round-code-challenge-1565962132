...
VendorSweet.create(price: 60, vendor_id: 1, sweet_id: 2)
VendorSweet.create(price: 50, vendor_id: 1, sweet_id: 3)
VendorSweet.create(price: 30, vendor_id: 2, sweet_id: 3)
VendorSweet.create(price: 20, vendor_id: 3, sweet_id: 4)
VendorSweet.create(price: 10, vendor_id: 4, sweet_id: 4)
